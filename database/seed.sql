INSERT INTO firms (name) VALUES ('Hızlı Turizm');

INSERT INTO users (name, email, password_hash, role, firm_id, credit_cents)
VALUES
('Sistem Admin', 'admin@example.com', 'TO_BE_HASHED', 'ADMIN', NULL, 0),
('Firma Admin', 'firma@example.com', 'TO_BE_HASHED', 'FIRM_ADMIN', 1, 0),
('Helin', 'helin@example.com', 'TO_BE_HASHED', 'USER', NULL, 150000);
